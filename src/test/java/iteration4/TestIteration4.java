...
public class TestIteration4 {

	public TestIteration4() {
	...
	public void setUp() throws Exception {
		...
		Cellule[][] celluleAvant = { { c2, c2, c2 }, { c1, c1, c1 }, { c2, c2, c2 }, };
		this.initiale = new Table(celluleAvant);
		Cellule[][] evolution1 = { { c2, c1, c2 }, { c2, c1, c2 }, { c2, c1, c2 } };

		this.evolution1 = new Table(evolution1);

		this.evolution2 = new Table(celluleAvant);
